...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Confirmamos la fecha con un abono del 50% del valor del paquete. El saldo se cancela el día del montaje. Aceptamos Nequi, Bancolombia, Llave Bre-B, transferencia bancaria y efectivo.',
  },
];
