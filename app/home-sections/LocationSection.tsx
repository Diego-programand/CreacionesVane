            ...
            <div className="space-y-6">
              <div className="text-center lg:text-left">
                ...
                <p className="text-gray-600 text-base md:text-lg mb-6">
                  Te esperamos en nuestro local para que conozcas de cerca la calidad de nuestros productos
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 border border-primary-100">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-bold text-gray-800 text-lg mb-2">Nuestra Ubicación</h3>
                    ...
                    <a
                      href="https://maps.app.goo.gl/uasNUEWYMZH2HMLS8"
                      target="_blank"
              ...
              <div className="rounded-2xl overflow-hidden shadow-xl border-4 border-white">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.688721771749!2d-75.55514592416081!3d6.3045666256670545!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e442fe65134f5af%3A0xb601e7f18818004f!2sCreaciones%20Vane!5e0!3m2!1ses!2sco!4v1768813507799!5m2!1ses!2sco"
                  width="100%"
                  height="300"
                  style={{ border: 0 }}
                  allowFullScreen
