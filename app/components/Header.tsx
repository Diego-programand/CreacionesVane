...
export default function Header() {
  ...
  return (
    <header className="bg-white/95 backdrop-blur-md shadow-lg sticky top-0 z-50 border-b border-primary-100 max-w-full overflow-x-hidden">
      {/* Top Banner de Alerta de Estafas */}
      <div className="bg-gradient-to-r from-rose-600 via-pink-600 to-rose-700 text-white text-[11px] sm:text-xs py-1.5 px-3 text-center font-medium flex items-center justify-center gap-1.5 flex-wrap">
        <svg className="w-3.5 h-3.5 text-rose-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
        </svg>
        <span><strong>Aviso importante:</strong> Alerta de suplantación y estafas.</span>
        <Link
          href="/blog/comunicado-oficial-alerta-estafas-suplantacion-identidad-creaciones-vane"
          className="underline font-bold hover:text-rose-100 transition-colors"
        >
          Ver números autorizados y comunicado &rarr;
        </Link>
      </div>
