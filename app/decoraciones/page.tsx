...
export default async function DecoracionesPage() {
  ...
  /**
   * LocalBusiness específico de la línea Decoraciones.
   * NO duplica NAP del Organization global. Referencia vía parentOrganization @id.
   */
  const jsonLdLocalBusiness = {
    '@context': 'https://schema.org',
    '@type': 'LocalBusiness',
    '@id': `${BUSINESS.url}/decoraciones#localbusiness`,
    ...
    priceRange: '$$-$$$',
    image: [
      `${BUSINESS.url}/banner-decoraciones.webp`,
      ...
      itemListElement: [
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              'Montaje de lujo con fondo Shimmer, múltiples backings, arcos de puerta, números luminosos y figuras a escala. Ideal para eventos especiales de gran formato.',
            provider: { '@id': `${BUSINESS.url}/#organization` },
            areaServed: 'Medellín, Antioquia',
            offers: {
              '@type': 'Offer',
  ...
  const faq = faqSchema([
    {
      q: '¿El precio incluye montaje y desmontaje?',
      a: 'Sí, todos nuestros paquetes incluyen el servicio completo de transporte, montaje profesional y desmontaje al finalizar el evento en el área metropolitana de Medellín (El Poblado, Laureles, Envigado, Sabaneta).',
    },
    {
      q: '¿Puedo personalizar los colores y la temática?',
      a: 'Por supuesto. Adaptamos cada decoración a tus preferencias de colores, temática del evento y estilo. Trabajamos con temas infantiles (Paw Patrol, Toy Story, Stitch), elegantes (bodas, quinceañeras) y personalizados.',
    },
    {
      q: '¿Con cuánto tiempo de anticipación debo reservar?',
      a: 'Recomendamos reservar con al menos 1 semana de anticipación para garantizar disponibilidad. Para fechas especiales (diciembre, día de la madre) sugerimos reservar con 2–3 semanas.',
    },
    {
      q: '¿Hacen decoraciones para eventos al aire libre?',
      a: 'Sí, decoramos eventos en espacios cerrados y al aire libre (fincas, jardines, terrazas). Tomamos precauciones especiales considerando condiciones climáticas.',
    },
    {
      ...
      itemListElement: [
        {
          ...
          name: 'Bodas',
          itemListElement: [
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Decoración Bodas Completa' } },
          ],
        },
        {
          '@type': 'OfferCatalog',
          ...
          itemListElement: [
            {
              '@type': 'Offer',
              itemOffered: { '@type': 'Service', name: 'Decoración Temática Infantil' },
            },
          ],
        },
        {
          ...
          name: 'Baby Shower',
          itemListElement: [
            { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Decoración Baby Shower' } },
          ],
        },
      ],
    },
