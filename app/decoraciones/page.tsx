...
export default function DecoracionesPage() {
  ...
  const Pagination = () => {
    ...
    return (
      <nav className="flex items-center justify-center gap-2 mt-12" role="navigation" aria-label="Paginación de decoraciones">
        <button
  ...
  return (
    <>
              ...
              "hasOfferCatalog": {
                ...
                "itemListElement": [
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Decoración Quinceañera",
                      "description": "Decoración elegante para fiesta de 15 años con mesa principal, arco de globos e iluminación",
                      "offers": {
                        "@type": "Offer",
                        "priceCurrency": "COP",
                        "price": "320000",
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      "@type": "Service",
                      "name": "Decoración Princesas Disney",
                      "description": "Decoración temática de princesas con backdrop fotográfico y centros de mesa",
                      "offers": {
                        "@type": "Offer",
                        "priceCurrency": "COP",
                        "price": "300000",
      ...
      <main className="min-h-screen">
        ...
        <section id="catalog-section" className="py-16 bg-gradient-to-b from-white to-decoraciones-surface overflow-x-hidden" aria-label="Catálogo de decoraciones">
          <div className="container mx-auto px-3 sm:px-4 max-w-full">
            ...
            {mobileFiltersOpen && (
              <aside 
                ...
                role="dialog"
                aria-modal="true"
                aria-label="Filtros de decoraciones"
              >
                ...
                <ScrollReveal direction="up">
                  <div className="mb-8">
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-3">
                      Nuestras Decoraciones
                    </h2>
                    <p className="text-lg text-gray-600" role="status" aria-live="polite">
                      Mostrando {startIndex + 1}-{Math.min(endIndex, productosFiltrados.length)} de {productosFiltrados.length} decoraciones
                    </p>
                  </div>
                </ScrollReveal>
