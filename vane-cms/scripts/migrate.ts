...
const productosMock: ProductoMock[] = [
    ...
    { id: 'det-des-007', nombre: 'Mi Primera Gran Sorpresa: Pocoyó', descripcion: 'Desayuno infantil de Pocoyó en Medellín para los más pequeñitos.', precio: 90000, imagen: getCldUrl('desayuno7_olop8r'), categoria: 'Detalles', destacado: false },
